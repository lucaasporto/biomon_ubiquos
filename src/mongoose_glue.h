...
void glue_get_ip(struct ip *);

struct gerenciar_celula {
  bool c12;
  bool c11;
  bool c10;
  bool c09;
...
void glue_get_gerenciar_celula(struct gerenciar_celula *);
void glue_set_gerenciar_celula(struct gerenciar_celula *);

struct config {
  bool dashboard_ativa;
  double salvamento_atual_sheet;
  double salvamento_novo_sheet;
};
void glue_get_config(struct config *);
void glue_set_config(struct config *);
...
void glue_get_texto(struct texto *);
...
void glue_get_resumo(struct resumo *);
...
void glue_get_tensoes(struct tensoes *);
