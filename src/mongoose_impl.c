...
struct attribute s_ip_attributes[] = {
  {"local", "string", NULL, offsetof(struct ip, local), 40, false},
  {"esp32", "string", NULL, offsetof(struct ip, esp32), 40, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_gerenciar_celula_attributes[] = {
  {"c12", "bool", NULL, offsetof(struct gerenciar_celula, c12), 0, false},
  {"c11", "bool", NULL, offsetof(struct gerenciar_celula, c11), 0, false},
  {"c10", "bool", NULL, offsetof(struct gerenciar_celula, c10), 0, false},
  {"c09", "bool", NULL, offsetof(struct gerenciar_celula, c09), 0, false},
  {"c08", "bool", NULL, offsetof(struct gerenciar_celula, c08), 0, false},
  {"c07", "bool", NULL, offsetof(struct gerenciar_celula, c07), 0, false},
  {"c06", "bool", NULL, offsetof(struct gerenciar_celula, c06), 0, false},
  {"c05", "bool", NULL, offsetof(struct gerenciar_celula, c05), 0, false},
  {"c04", "bool", NULL, offsetof(struct gerenciar_celula, c04), 0, false},
  {"c03", "bool", NULL, offsetof(struct gerenciar_celula, c03), 0, false},
  {"c02", "bool", NULL, offsetof(struct gerenciar_celula, c02), 0, false},
  {"c01", "bool", NULL, offsetof(struct gerenciar_celula, c01), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_config_attributes[] = {
  {"dashboard_ativa", "bool", NULL, offsetof(struct config, dashboard_ativa), 0, false},
  {"salvamento_atual_sheet", "double", NULL, offsetof(struct config, salvamento_atual_sheet), 0, false},
  {"salvamento_novo_sheet", "double", NULL, offsetof(struct config, salvamento_novo_sheet), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_wifi_attributes[] = {
  {"pass_novo", "string", NULL, offsetof(struct wifi, pass_novo), 64, false},
  {"ssid_novo", "string", NULL, offsetof(struct wifi, ssid_novo), 32, false},
  {"pass_atual", "string", NULL, offsetof(struct wifi, pass_atual), 64, false},
  {"ssid_atual", "string", NULL, offsetof(struct wifi, ssid_atual), 32, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_texto_attributes[] = {
  {"wifi", "string", NULL, offsetof(struct texto, wifi), 13, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_resumo_attributes[] = {
  {"menor", "double", "%.2f", offsetof(struct resumo, menor), 0, false},
  {"maior", "double", "%.2f", offsetof(struct resumo, maior), 0, false},
  {"media", "double", "%.2f", offsetof(struct resumo, media), 0, false},
  {"ativos", "int", NULL, offsetof(struct resumo, ativos), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_tensoes_attributes[] = {
  {"t12", "double", "%.2f", offsetof(struct tensoes, t12), 0, false},
  {"t11", "double", "%.2f", offsetof(struct tensoes, t11), 0, false},
  {"t10", "double", "%.2f", offsetof(struct tensoes, t10), 0, false},
  {"t09", "double", "%.2f", offsetof(struct tensoes, t09), 0, false},
  {"t08", "double", "%.2f", offsetof(struct tensoes, t08), 0, false},
  {"t07", "double", "%.2f", offsetof(struct tensoes, t07), 0, false},
  {"t06", "double", "%.2f", offsetof(struct tensoes, t06), 0, false},
  {"t05", "double", "%.2f", offsetof(struct tensoes, t05), 0, false},
  {"t04", "double", "%.2f", offsetof(struct tensoes, t04), 0, false},
  {"t03", "double", "%.2f", offsetof(struct tensoes, t03), 0, false},
  {"t02", "double", "%.2f", offsetof(struct tensoes, t02), 0, false},
  {"t01", "double", "%.2f", offsetof(struct tensoes, t01), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_data s_apihandler_ip = {{"ip", "data", true, 0, 0, 0UL}, s_ip_attributes, sizeof(struct ip), (void (*)(void *)) glue_get_ip, NULL};
struct apihandler_data s_apihandler_gerenciar_celula = {{"gerenciar_celula", "data", false, 0, 0, 0UL}, s_gerenciar_celula_attributes, sizeof(struct gerenciar_celula), (void (*)(void *)) glue_get_gerenciar_celula, (void (*)(void *)) glue_set_gerenciar_celula};
struct apihandler_data s_apihandler_config = {{"config", "data", false, 0, 0, 0UL}, s_config_attributes, sizeof(struct config), (void (*)(void *)) glue_get_config, (void (*)(void *)) glue_set_config};
...
struct apihandler_data s_apihandler_texto = {{"texto", "data", true, 0, 0, 0UL}, s_texto_attributes, sizeof(struct texto), (void (*)(void *)) glue_get_texto, NULL};
struct apihandler_data s_apihandler_resumo = {{"resumo", "data", true, 0, 0, 0UL}, s_resumo_attributes, sizeof(struct resumo), (void (*)(void *)) glue_get_resumo, NULL};
struct apihandler_data s_apihandler_tensoes = {{"tensoes", "data", true, 0, 0, 0UL}, s_tensoes_attributes, sizeof(struct tensoes), (void (*)(void *)) glue_get_tensoes, NULL};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_ip,
  (struct apihandler *) &s_apihandler_gerenciar_celula,
  (struct apihandler *) &s_apihandler_config,
  (struct apihandler *) &s_apihandler_wifi,
  (struct apihandler *) &s_apihandler_texto,
  (struct apihandler *) &s_apihandler_resumo,
  (struct apihandler *) &s_apihandler_tensoes
};
